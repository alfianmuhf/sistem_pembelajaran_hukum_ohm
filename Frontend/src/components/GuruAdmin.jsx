...
const GuruAdmin = () => {
  ...
  const handleDelete = async (id) => {
    if (!window.confirm('Apakah Anda yakin ingin menghapus akun guru ini?')) return;
                  ...
                  <tr key={guru.id_guru}>
                    ...
                    <td>
                      <div className="action-buttons">
                        ...
                        <button className="btn-icon btn-delete" title="Hapus Guru" onClick={() => handleDelete(guru.id_guru)}>
                          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
